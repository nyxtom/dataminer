...
/**
 * Determines if the given hash field exists in the key.
 *
 * @param {String} key
 * @param {String} field
 * @param {Function} callback
...
Manager.prototype.hExists = function (key, field, callback) {
    this.client.hexists([key, field], function (err, response) {
        callback(err, response);
    });
};

/**
 * Returns a list of hash field values for the given key.
 *
 * @param {String} key
 * @param {Function} callback
 * @api public
...
Manager.prototype.hVals = function (key, callback) {
    this.client.hvals([key], function (err, response) {
        callback(err, response);
    });
};
